...
const REGRAS_CLASSIFICACAO: { etapa: string; padroes: string[] }[] = [
  ...
  { etapa: 'Revestimentos Internos', padroes: ['revestimentos cerâmicos internos', 'massa única interna', 'chapisco', 'gesso', 'revestimentos cerâmicos externos', 'massa única externa', 'monocapa', 'fachadas com placas'] },
